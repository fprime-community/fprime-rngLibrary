// ======================================================================
// \title  MainDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef MAINDEPLOYMENT_MAINDEPLOYMENTTOPOLOGY_HPP
#define MAINDEPLOYMENT_MAINDEPLOYMENTTOPOLOGY_HPP
// Included for access to MainDeployment::TopologyState and MainDeployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <MainDeployment/Top/MainDeploymentTopologyDefs.hpp>

// Remove unnecessary MainDeployment:: qualifications
 ...
 * MainDeployment::TopologyState see: MainDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type MainDeployment::TopologyState see: MainDeploymentTopologyDefs.hpp.
 *
